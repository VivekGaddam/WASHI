      ...
      <View style={styles.filtersRow}>
        ...
        <View style={styles.deptBox}>
          ...
          <View style={styles.deptRow}>
            <TouchableOpacity onPress={() => setSelectedDept('')} style={[styles.deptBtn, selectedDept === '' && styles.filterBtnActive]}>
              <Text style={[styles.filterBtnText, selectedDept === '' && { color: '#fff' }]}>All</Text>
            </TouchableOpacity>
            <FlatList
              data={departments}
              horizontal
              ...
              renderItem={({ item }) => (
                <TouchableOpacity
                  onPress={() => setSelectedDept(item.name)}
                  style={[styles.deptBtn, selectedDept === item.name && styles.filterBtnActive]}
                >
                  <Text style={[styles.filterBtnText, selectedDept === item.name && { color: '#fff' }]}>{item.name}</Text>
                </TouchableOpacity>
              )}
            />
          </View>
